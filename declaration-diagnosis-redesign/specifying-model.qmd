...
It is also possible to use the distribution over quantities in a model to represent our *uncertainty* over some quantities and in this way let our diagnostics integrate over our uncertainty. We did this already in Declaration @def-declarationch2num1 where we let the treatment effect be a random draw from a stipulated distribution. In doing this the success function represents expected success with respect to this distribution over treatment effects.   
