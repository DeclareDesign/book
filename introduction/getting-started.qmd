...
Every step in a research design can be declared using one of the `declare_*` functions. Table @tbl-declarationfunctions collects these according to the four elements of a research design. In Chapter \@ref(designingcode), we detail how to build each kind of step.
