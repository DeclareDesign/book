...
This part of the book works through stages of the research design lifecycle. The steps are all intertwined by their shared connection to the research design. We describe in each entry how we can use the declaration, diagnosis, and redesign framework to make progress at each step. Of course not every research project will feature each and every stage but the list should serve we hope as a useful checklist as you work through the major phases of your research.  
