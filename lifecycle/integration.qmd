...
```{r reanalysisdiagnosis, echo = FALSE}
...
Turning to the third metric (is the original outside the 95% confidence interval of the replication estimate), we find that we become more and more likely to conclude that the original study fails to replicate as the quality of the replication study goes up. At very large sample sizes, the replication confidence intervals become extremely small, so in the limit, it will always exclude the original study estimate.
