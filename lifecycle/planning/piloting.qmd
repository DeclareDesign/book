...
```{r figure-21-3, fig.cap = "Minimum required sample sizes and uncertainty over effect size", fig.width=6.5, fig.height=6.5, echo=FALSE}
imgsufx <- if(is_html_output()) "svg" else "pdf"
include_graphics(path = paste0("figures/figure_21.3.", imgsufx))
```
...
```{r figure-21-4, echo=FALSE, fig.width=6.5, fig.cap = "Distribution of post-pilot sample size choices"}
imgsufx <- if(is_html_output()) "svg" else "pdf"
include_graphics(path = paste0("figures/figure_21.4.", imgsufx))
```
