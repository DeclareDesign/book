...
```{r figure-21-2, echo = FALSE, fig.cap = "Finding the zone of agreement in a research partnership.", fig.width = 6.5, fig.height = 6.5}
imgsufx <- if(is_html_output()) "svg" else "pdf"
include_graphics(path = paste0("figures/figure_21.2.", imgsufx))
```
