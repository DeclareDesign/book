...
```{r figure-16-10, echo = FALSE, fig.cap = "Bias-variance tradeoff in bandwidth selection for the regression discontinuity design."}
imgsufx <- if(is_html_output()) "svg" else "pdf"
include_graphics(path = paste0("figures/figure_16.10.", imgsufx))
```
