...
We can adopt an instrumental variables answer strategy --- using two-stage least squares, for example --- to estimate the LATE. Angrist, Imbens, and Rubin (1996) show that this LATE estimand can be identified under the following five assumptions:
