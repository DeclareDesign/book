...
```{r figure-15-3,echo=FALSE, fig.cap="Trading off the number of clusters and the number of individuals per cluster", fig.height=3.5, fig.width=6.5}
imgsufx <- if(is_html_output()) "svg" else "pdf"
include_graphics(path = paste0("figures/figure_15.3.", imgsufx))
```
