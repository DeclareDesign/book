...
In @def-ch15num6, our inquiry is the average level of the latent variable among units whose binary covariate `X` is equal to one.
...
@fig-ch15num7 shows the distribution of estimates from different approaches to generating indices. A few features stand out from the distribution of estimates. 
