...
The audit experiment design we'll explore in this chapter has data and answer strategies that are identical to the two-arm trial for causal inference described in @sec-ch18s1. The difference between an audit study and the typical randomized experiment lies in the model and inquiry. In a two-arm trial, a common (causal) inquiry is the average difference between the treated and untreated potential outcomes, the ATE. In an audit experiment, by contrast, the inquiry is descriptive: what is the fraction of the sample that discriminates?
...
- @coppock2017did compares direct question and list experimental estimates of support for Donald Trump during the 2016 election, finding no evidence for "shy" Trump supporters who misreport their support for Trump for fear of being perceived as racist or sexist by enumerators.
...
![Sampling Distribution of five AMCE estimators. Bands are constructed by sorting and stacking the confidence intervals generated from many simulations. Statistical significance of estimates indicated by color](/figures/figure-17-3){#fig-ch17num3}
...
A sample of data that might be produced by this design is shown in @tbl-behavioralgames. 
