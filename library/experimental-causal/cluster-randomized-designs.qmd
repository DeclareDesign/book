...
Figure \@ref(fig:figure-18-5) shows the sampling distribution of the difference-in-means estimator under cluster random assignment at three levels of intra-cluster correlation ranging from 0.1 to 0.9.
...
```{r figure-18-5, echo=FALSE, fig.cap="Sampling distribution under differenct ICCs", fig.width=6.5, fig.height=6.5}
imgsufx <- if(is_html_output()) "svg" else "pdf"
include_graphics(path = paste0("figures/figure_18.5.", imgsufx))
```
