...
![Directed acyclic graph of a two-arm randomized experiment](/figures/figure-18-1){#fig-ch18fig1}

:::{.definition #declarationch18dec1} 
...
![Comparing the Lin estimator to OLS and difference-in-means, varying fraction assigned to treatment and correlation of potential outcomes with the covariate.](/figures/figure-18-3){#fig-ch18fig3}
