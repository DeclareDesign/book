...
Declaration @def-declarationch18dec9 actually includes two separate designs. Here we'll directly compare the standard encouragement design to the placebo-controlled design. They have identical models and inquiries, so we'll just declare those once, before declaring the specifics of the empirical strategies for each design.

:::{.definition #declarationch18dec9} 
...
![Comparison of the placebo-controlled design to a standard encouragment design](/figures/figure-18-11){#fig-ch18fig11}
