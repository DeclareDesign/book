...
Declaration \@ref(def:declaration-18-9) actually includes two separate designs. Here we'll directly compare the standard encouragement design to the placebo-controlled design. They have identical models and inquiries, so we'll just declare those once, before declaring the specifics of the empirical strategies for each design.

:::{.definition #declaration-18-9} 
...
```{r figure-18-11, echo=FALSE, fig.width = 6.5, fig.height=3, fig.cap="Comparison of the placebo-controlled design to a standard encouragment design"}
imgsufx <- if(is_html_output()) "svg" else "pdf"
include_graphics(path = paste0("figures/figure_18.11.", imgsufx))
```
