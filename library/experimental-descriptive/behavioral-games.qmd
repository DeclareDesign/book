...
We illustrate using the "trust" game in which we specify three common inquiries and use a standard design in Declaration @def:declaration-17-6. The design is successful at generating unbiased estimates of the first inquiry but runs into problems with the other two.   
