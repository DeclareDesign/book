...
We illustrate using the "trust" game in which we specify three common inquiries and use a standard design in Declaration @def-declarationch17dec6. The design is successful at generating unbiased estimates of the first inquiry but runs into problems with the other two.   
...
:::{.definition #declarationch17dec6} 
...
![Diagnosis of bias in the analysis of trust games with and without deception](/figures/figure-17-5){#fig-ch17fig5}
