...
```{r figure-17-2, fig.cap = "Redesign to illustrate tradeoffs in RMSE between list experiment and direct question", echo = FALSE}
imgsufx <- if(is_html_output()) "svg" else "pdf"
include_graphics(path = paste0("figures/figure_17.2.", imgsufx))
```
